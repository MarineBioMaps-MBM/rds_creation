# Creating an RDS file for the biota data for the San Francisco Bay Study Region (SFBSR)
...
file_path <- file.path(rds_outputs, "sfbsr_bio.rds")
saveRDS(sfbsr_bio, file = file_path)